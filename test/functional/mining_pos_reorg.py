...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        ...
        # verify that nodes have the expected USDX supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check USDX supply at the beginning
        # ------------------------------------------
        # USDX supply: block rewards minus burned fees for minting
        ...
        # Verify that USDX supplies were properly updated after the spends and reorgs
        self.log.info("Check USDX supply...")
