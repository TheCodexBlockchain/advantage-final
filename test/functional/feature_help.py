...
"""Verify that starting advantage with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start advantage with -? for help text")
        ...
        self.log.info("Start advantage with -version for version information")
