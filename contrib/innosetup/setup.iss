...
#define MyAppName "Advantage Core"
#define MyAppPublisher "2022 DECENOMY Core Developers"
#define MyAppURL "https://advantage.com"
#define MyAppExeName "advantage-qt.exe"
#define MyAppExtraData "https://explorer.decenomy.net/bootstraps/USDX/bootstrap.zip"
...
DefaultDirName={autopf}\Advantage
...
OutputDir=.\output
OutputBaseFilename=AdvantageSetup
...
DefaultGroupName=Advantage Core
...
[Files]
Source: ".\package\advantage-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Advantage\Advantage-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Advantage\Advantage-Qt,strDataDir|{userappdata}\Advantage\}');
  Result := True;
end;
